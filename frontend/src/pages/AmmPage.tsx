...
const CHART = {
    line: '#2563EB',
    gradA: 'rgba(96,165,250,0.28)',
    gradB: 'rgba(96,165,250,0.02)',
...
export default function AmmPage() {
    ...
    return (
        <motion.div {...fadeUp} className="h-full flex flex-col gap-4">
            ...
            {/* Tab Content */}
            <div className="flex-1 grid grid-cols-[1fr_360px] gap-5 min-h-0">
                {activeTab === 'swap' ? (
                    <>
                        {/* ── SWAP TAB ── */}
                        <div className="flex flex-col gap-4">
                            ...
                            <GlassCard delay={0.1} className="rounded-3xl p-4 shrink-0">
                                ...
                                <div className="space-y-0.5">
                                    <div className="grid grid-cols-[24px_1fr_auto_auto] gap-4 px-3 pb-2 border-b border-[rgba(0,0,0,0.06)]">
                                        {['#', 'Tx Hash', 'Amount', 'Status'].map(h => (
                                            <p key={h} className="text-[8px] uppercase tracking-widest text-[#8B93A4] font-semibold">{h}</p>
                                        ))}
                                    </div>
                                    {zkRows.slice(0, 4).map((row, i) => {
                                        ...
                                        return (
                                            <motion.div key={row.hash}
                                                ...
                                                className="grid grid-cols-[24px_1fr_auto_auto] gap-4 items-center px-3 py-2 rounded-xl"
                        ...
                        <div className="flex flex-col">
                            ...
                            <GlassCard delay={0} className="rounded-3xl p-6 flex-1 flex flex-col">
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        <p className="text-[15px] font-bold text-[#1A1D23]">Bonding Curve</p>
                                        <p className="metric-value text-[12px] font-semibold mt-0.5" style={{ color: CHART.line }}>
                                    ...
                                    <div className="flex gap-6">
                                        <div className="text-right">
                                            ...
                                            <p className="metric-value text-[18px] font-bold text-[#1565C0]">{spotPx}</p>
                                            <p className="text-[9px] text-[#8B93A4]">USDC/kWh</p>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-[9px] text-[#8B93A4] uppercase tracking-widest">TVL</p>
                                            <p className="metric-value text-[18px] font-bold text-[#2E7D32]">${tvl}</p>
                                ...
                                {[
                                    ...
                                    <div key={r.label} className="mb-3 last:mb-0">
                                        <div className="flex justify-between mb-1.5">
                                            <span className="text-[10px] text-[#4B5263]">{r.label}</span>
                                            <span className="metric-value text-[12px] font-bold" style={{ color: r.color }}>
